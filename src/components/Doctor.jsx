...
function Doctor() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      alert(error.message); // Ideally, use a toast notification here
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl animate-fade-in relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 -mr-16 -mt-16 w-32 h-32 bg-blue-500/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-32 h-32 bg-emerald-500/20 rounded-full blur-3xl" />

        <div className="relative z-10">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center p-4 rounded-full bg-blue-500/10 mb-4 ring-1 ring-blue-500/20">
            ...
            <p className="text-slate-400">
              {isLogin
                ? "Sign in to manage prescriptions securely"
                : "Create your verified medical account"}
            </p>
          </div>
