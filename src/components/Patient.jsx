...
import { UserCircle, Mail, Lock, User, ArrowRight, Loader2 } from "lucide-react";
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl animate-fade-in relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center p-4 rounded-full bg-emerald-500/10 mb-4 ring-1 ring-emerald-500/20">
            ...
            <p className="text-slate-400">
              {isLogin
                ? "Access your prescriptions securely"
                : "Join the secure blockchain network"}
            </p>
          </div>
